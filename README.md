...
At the [Center for Energy and Geo Processing (CeGP)](https://cegp.ece.gatech.edu/) and at the [OLIVES lab](www.ghassanalregib.com), we have been working on creating big datasets for post-migrated seismic volumes.
